        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-start mb-16">
          <div className="flex p-2 rounded-[2rem] border bg-white shadow-xl border-slate-100">
            <button
              ...
              className={`relative px-10 py-4 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.2em] transition-all duration-500 font-serif ${activeTab === 'admissions' ? 'bg-[#0f172a] text-white shadow-2xl shadow-slate-900/20' : 'text-slate-400 hover:text-slate-600'}`}
            >
              Admissions
            </button>
